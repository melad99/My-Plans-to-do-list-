...
import com.myplans.myplan.task_database.TaskContract;
import com.myplans.myplan.task_database.TaskDatabaseHelper;
        ...
        switch (item.getItemId()) {
            case R.id.action_add_task:
                ...
                AlertDialog dialog = new AlertDialog.Builder(this)
                        .setTitle("Add a new plan").setMessage("your future goal?").setView(taskEdit)
